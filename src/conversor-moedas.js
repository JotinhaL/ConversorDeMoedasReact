...
function ConversorMoedas() {
  ...
  const [exibirMensagemDeErro, setExibirMensagemDeErro] = useState(false);
  ...
  <div>
    ...
    <Alert variant = "danger" show = {exibirMensagemDeErro}>
